//
//  MembersPFQueryTableViewController.m
//  Roommates
//
//  Created by Gjermund Bjaanes on 13/04/14.
//  Copyright (c) 2014 Real Kode. All rights reserved.
//

#import "HouseholdMembersPFQueryTableViewController.h"
#import "User.h"

@interface HouseholdMembersPFQueryTableViewController ()

@end

@implementation HouseholdMembersPFQueryTableViewController
...
- (PFQuery *)queryForTable {
    ...
    if ([[User currentUser] isMemberOfAHousehold]) {
        [query whereKey:@"activeHousehold" equalTo:[User currentUser].activeHousehold];
    }
    else {
                        ...
                        object:(PFObject *)object
{
    ...
    cell.imageView.file = member.profilePicture;
