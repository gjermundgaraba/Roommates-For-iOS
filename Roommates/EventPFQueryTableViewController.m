...
// Sets the height of the rows. 44 is standard
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row < self.objects.count) {
        ...
        UIAlertView *noteAlertView = [[UIAlertView alloc] initWithTitle:title message:event.descriptionString delegate:nil cancelButtonTitle:@"Close" otherButtonTitles:nil];
        [noteAlertView show];
